...
def load_model():
    client = mlflow.tracking.MlflowClient(tracking_uri="http://34.100.166.236:5000")
...
def run():
    ...
    argparser.add_argument('--taxi_type', default='yellow', help='type of taxi: yellow or green')
    argparser.add_argument('--year', default=2023, type=int, help='year of the data')
    argparser.add_argument('--month', default=1, type=int, help='month of the data')
